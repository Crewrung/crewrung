...
public class BoardRecentVO {
    ...
    public BoardRecentVO() {}

    
    
    public BoardRecentVO(Long boardNumber, String writerId, String title, String content, Date writingDate,
			Integer viewCount) {
		super();
